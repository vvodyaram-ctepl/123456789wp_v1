...
export class MultiselectComponent implements OnInit {
  ...
  @Input() dropdownSettingsText: string;
  @Input() customDropdownSettings: any;
  ...
  ngOnInit() {
    ...
    if (this.dropdownSettingsText && this.dropdownSettingsText != '') {
      this.dropdownSettings.text = this.dropdownSettingsText;
    }
