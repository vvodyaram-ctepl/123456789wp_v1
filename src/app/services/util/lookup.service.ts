...
export class LookupService extends BaseService {
  ...
  public getCommon(url: string, data?: any): Observable<any> {
  ...
  public getCategories(): Observable<any> {
    return this.get('/api/lookup/getQuestionCategoryList');
  }

  public getValidityPeriods(): Observable<any> {
    return this.get('/api/lookup/getQuestionValidityPeriods');
  }
