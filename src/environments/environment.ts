...
export const environment = {
  production: false,
  gcpStoragePath: 'https://storage.googleapis.com/wearables-sensor-data-pr/QA/GCloud/WPortal/',
  grantType: 'password',
  ...
  // baseUrl: 'http://localhost:8080/wearables',
  baseUrl: 'https://wp-service-longitudinal-dev-ygue7fpaba-uc.a.run.app/wearables',
  firebase: {
